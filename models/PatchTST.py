...
class PatchTST(nn.Module):
    def __init__(self, num_classes_1, configs, max_seq_len:Optional[int]=2048, d_k:Optional[int]=None, d_v:Optional[int]=None, norm:str='BatchNorm', attn_dropout:float=0., 
    ...
    def forward(self, x):           # x: [Batch, Input length, Channel]
        ...
        return classification_output_1, regression_output
